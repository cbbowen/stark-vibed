...
//!
//! ```sh
//! cargo run -p stark-core --example repro_bleed -- <file.stark> [out_dir] [--synth|--identity]
//! ```
//!
...
use stark_core::document::{ActionKind, FillOp, SelectionShape};
use stark_core::engine::headless_engine;
use stark_core::geom::{Extent2, Vec2};
use stark_core::io::DocumentFile;
