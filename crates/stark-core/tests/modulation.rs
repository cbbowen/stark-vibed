...
fn stroke_pen(engine: &mut stark_core::Engine, b: BrushParams, points: &[Vec2], pen: (f32, f32)) {
...
fn ink(before: &stark_core::RgbaImage, after: &stark_core::RgbaImage) -> f64 {
    before
        .pixels
        .as_chunks::<4>()
        .0
...
fn covered(before: &stark_core::RgbaImage, after: &stark_core::RgbaImage) -> u64 {
    before
        .pixels
        .as_chunks::<4>()
        .0
...
fn two_marks(
    ...
    a_pen: (f32, f32),
    b_pen: (f32, f32),
    measure: impl Fn(&stark_core::RgbaImage, &stark_core::RgbaImage) -> f64,
) -> (f64, f64) {
