...
| N | Native frontend to parity (§11.2) | N0, N1 done — `stark-chrome` holds the five pure modules, the record format and its `Backend`; the native app keeps a store and reopens at its size. N2–N9 **not started** |
