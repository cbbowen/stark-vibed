//! The WGPUI geometry module is a collection of types and traits that
...
impl Point<Pixels> {
    ...
    ///
    /// ```
    /// # use wgpui::{Point, Pixels, ScaledPixels};
...
impl Size<Pixels> {
    ...
    ///
    /// ```
    /// # use wgpui::{Size, Pixels, ScaledPixels};
    ...
    T: Add<T, Output = T> + Clone + Debug + Default + PartialEq,
{
    ...
    ///
    /// ```
    /// use wgpui::{Bounds, Corner, Point, Size};
    /// let bounds = Bounds {
    ///     origin: Point { x: 0, y: 0 },
    ///     size: Size { width: 10, height: 20 },
    /// };
...
impl Bounds<Pixels> {
    ...
    ///
    /// ```
    /// # use wgpui::{Bounds, Point, Size, Pixels, ScaledPixels, DevicePixels};
    /// let bounds = Bounds {
...
impl Edges<Length> {
    ...
    ///
    /// ```
    /// # use wgpui::{DefiniteLength, Edges, Length, Pixels};
...
impl Edges<DefiniteLength> {
    ...
    ///
    /// ```
    /// # use wgpui::{px, DefiniteLength, Edges};
    ...
    ///
    /// ```
    /// # use wgpui::{Edges, DefiniteLength, px, AbsoluteLength, rems, Size};
    /// let edges = Edges {
...
impl Edges<AbsoluteLength> {
    ...
    ///
    /// ```
    /// # use wgpui::{AbsoluteLength, Edges, Pixels};
    ...
    ///
    /// ```
    /// # use wgpui::{Edges, AbsoluteLength, Pixels, px, rems};
    /// let edges = Edges {
...
impl Edges<Pixels> {
    ...
    ///
    /// ```
    /// # use wgpui::{Edges, Pixels, ScaledPixels};
    /// let edges = Edges {
...
impl Corners<AbsoluteLength> {
    ...
    ///
    /// ```
    /// # use wgpui::{Corners, AbsoluteLength, Pixels, Rems, Size};
    /// let corners = Corners {
...
impl Corners<Pixels> {
    ...
    ///
    /// ```
    /// # use wgpui::{Corners, Pixels, ScaledPixels};
    /// let corners = Corners {
...
impl AbsoluteLength {
    ...
    ///
    /// ```
    /// # use wgpui::{AbsoluteLength, Pixels, Rems};
...
impl DefiniteLength {
    ...
    ///
    /// ```
    /// # use wgpui::{DefiniteLength, AbsoluteLength, Pixels, px, rems};
