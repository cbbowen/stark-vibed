...
/// A click event that was generated by a recognized tap gesture on a touch screen.
#[derive(Clone, Debug, Default)]
pub struct TouchClickEvent {
    /// The position of the tap in window coordinates.
    pub position: Point<Pixels>,
    /// The number of consecutive taps at this location.
    pub tap_count: usize,
    /// Whether this was a long press rather than a tap.
    pub long_press: bool,
}
...
impl ClickEvent {
    ...
    /// Returns whether the click was a middle click
...
mod test {
    ...
    use crate::{
        self as wgpui, AppContext as _, Context, FocusHandle, InteractiveElement, IntoElement,
