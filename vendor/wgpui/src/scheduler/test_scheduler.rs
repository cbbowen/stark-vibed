...
impl TestScheduler {
    ...
    /// This is used by WGPUI's TestDispatcher to map dispatcher instances to sessions.
    ...
    ///
    /// This is the public interface for WGPUI's TestDispatcher to drive task execution.
