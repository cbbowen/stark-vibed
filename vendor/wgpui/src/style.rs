...
pub struct Style {
    ...
    /// to the X axis.
    ///
    /// Currently, WGPUI operates differently from the web in that it will scroll an element in either the X or Y axis
...
impl BoxShadow {
    /// Creates a new [`BoxShadow`] with the given offset and color.
...
/// The properties that can be used to style text in WGPUI
