...
//! 
// STARK PATCH: was `use windows::Win32::Foundation::HWND;`. See VENDORING.md — the
// whole `windows` dependency existed for this one import, and the crate's own
// `raw-dylib` signature already spells the same parameter `isize`.
use crate::c_type_aliases::HWND;
